...
function runTests(): void {
  ...
  assert(ms.getMin() === 2, "MinStack min"); ms.pop();
...
export { Stack, Queue, MinStack, isValidParens, evalRPN, generateParentheses, decodeString, dailyTemperatures, slidingWindowMaximum, largestRectangleHistogram };
